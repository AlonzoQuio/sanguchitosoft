...
import com.epissoft.sanguchito.controlador.categoriaproductoalmacencontrolador.ActualizarCategoriaProductoAlmacenControlador;
...
public class ActualizarCategoriaAlmacen extends javax.swing.JInternalFrame {
private File[] fotos;
    CategoriaProductoAlmacen categoria;
    public ActualizarCategoriaAlmacen(CategoriaProductoAlmacen cat) {
        initComponents();
        ...
        categoria=cat;
        tNombre.setText(cat.getCatProdAlmDes());
    ...
    private void initComponents() {
        ...
        lTitulo.setText("  ACTUALIZAR CATEGORIA ALMACEN");
 ...
 private void cargaDirectorio (String folder) {
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        String mensaje=ActualizarCategoriaProductoAlmacenControlador.actualizarCategoriaProductoAlmacen(categoria.getCatProdAlmCod(),tNombre.getText(), "catProdAlm" + tNombre.getText() + ".png");
        if (mensaje.equals("CORRECTO")) {
            if(jTImagen.getText().length()>2){
                ImageResizer.copyImage(jTImagen.getText(), ManejoSesion.getRuta() + "/Imagenes/", "catProdAlm" + tNombre.getText(), 60, 60);
                try {
                    Thread.sleep(500);
                } catch (InterruptedException ex) {
                }
            }else{
                File archivo=new File(ManejoSesion.getRuta() + "/Imagenes/" + categoria.getCatProdAlmImg());
                archivo.renameTo(new File(ManejoSesion.getRuta() + "/Imagenes/catProdAlm" + tNombre.getText()+".png"));
            }
            atras();
        } else {
