...
import com.epissoft.sanguchito.controlador.categoriaproductoalmacencontrolador.AgregarCategoriaProductoAlmacenControlador;
...
public class AgregarCategoriaAlmacen extends javax.swing.JInternalFrame {
private File[] fotos;
    
    public AgregarCategoriaAlmacen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lTitulo.setText("  REGISTRAR CATEGORIA ALMACEN");
 ...
 private void cargaDirectorio (String folder) {
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        if(jTImagen.getText().length()<2){
            ...
            String mensaje = AgregarCategoriaProductoAlmacenControlador.agregarCategoriaProductoAlmacen(tNombre.getText(), "catProdAlm" + tNombre.getText() + ".png");
