...
public class ListaTipoGasto extends javax.swing.JInternalFrame {

    public ListaTipoGasto() {
        initComponents();
        ...
        List<TipoGasto> list = TipoGastoControlador.listaTipoGasto();
        DefaultTableModel tabla = (DefaultTableModel)tabla_prod.getModel();
        for(TipoGasto iter : list){
        ...
        ButtonColumn b=new ButtonColumn(tabla_prod, new FuncionamientoBotonesTipoGasto(tabla_prod, list), 0);
    ...
    private void initComponents() {
        ...
        lTitulo.setText("  TIPOS DE GASTOS");
        ...
        tabla_prod.getColumnModel().getColumn(0).setMinWidth(100);
        tabla_prod.getColumnModel().getColumn(0).setPreferredWidth(100);
        tabla_prod.getColumnModel().getColumn(0).setMaxWidth(100);
        ...
        bAgregar.setText("+ Agregar Tipo Gasto");
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        ...
        AgregarTipoGasto actualizar = new AgregarTipoGasto();
    ...
    private void bAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAtrasActionPerformed
        ...
        Sanguchito.sanguchito.add(menuAdm);
        try {
            menuAdm.setMaximum(true);
        } catch (Exception e) {
        }
        menuAdm.show();
