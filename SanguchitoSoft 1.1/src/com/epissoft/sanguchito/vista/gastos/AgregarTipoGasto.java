...
public class AgregarTipoGasto extends javax.swing.JInternalFrame {

    
    public AgregarTipoGasto() {
        initComponents();
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        String resultado=TipoGastoControlador.agregarTipoGasto(tDescripcion.getText());
