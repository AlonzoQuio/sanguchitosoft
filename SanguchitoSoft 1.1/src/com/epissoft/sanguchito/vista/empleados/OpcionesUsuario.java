...
public class OpcionesUsuario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        modificar.setText("Modificar Datos Usuario");
        ...
        inhabilitar.setText("Inhabilitar Usuario");
    ...
    public void setDNI (String dni , String nombre){
        this.dni = dni;
        this.nombre = nombre;
    }
    ...
    private void inhabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inhabilitarActionPerformed
        ...
        if(!ec.buscarUsuarioNom(nombre).getUsuEst()){
            JOptionPane.showMessageDialog(null, "El usuario ya esta Inhabilitado");
        }
        else{
            dispose();
            InHabilitarUsuario mod = new InHabilitarUsuario();
            mod.setDNI(dni, nombre);
    ...
    private void habilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_habilitarActionPerformed
        ...
        UsuarioControlador ec = new UsuarioControlador();
        if(ec.buscarUsuarioNom(nombre).getUsuEst()){
            JOptionPane.showMessageDialog(null, "El Usuario ya esta Habilitado");            
        }
        else{
            dispose();
            HabilitarUsuario mod = new HabilitarUsuario();
            mod.setDNI(dni,nombre);
            mod.setLocation(Sanguchito.sanguchito.getWidth()/2-mod.getWidth()/2,Sanguchito.sanguchito.getHeight()/2-mod.getHeight()/2);
            Sanguchito.sanguchito.add(mod, new Integer(15));
            mod.show();
