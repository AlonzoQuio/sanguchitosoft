...
public class ListaCargos extends javax.swing.JInternalFrame {
    ...
    public ListaCargos() {
        ...
        List<Cargo> list = CargoControlador.listaCargos();
        DefaultTableModel tabla = (DefaultTableModel)tabla_prod.getModel();
        for(Cargo cargo : list){
            Object[]data ={new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ajuste.png")),cargo.getCarDes(),cargo.getCarObs()};
            tabla.addRow(data);            
        }       
