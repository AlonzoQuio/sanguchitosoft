...
public class ListaOpcionesCargos extends javax.swing.JInternalFrame {
    
    private Cargo cargo;
    public ListaOpcionesCargos(Cargo c) {
        initComponents();
        cargo=c;
        nomCategoria.setText(cargo.getCarDes());
    }
    ...
    private void initComponents() {
        ...
        bModificarCat.setText("Actualizar Cargo");
