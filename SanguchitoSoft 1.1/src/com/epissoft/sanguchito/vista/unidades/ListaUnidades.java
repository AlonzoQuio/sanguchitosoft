...
public class ListaUnidades extends javax.swing.JInternalFrame {
    ...
    public ListaUnidades() {
        ...
        List<UnidadMedida> list = UnidadMedidaControlador.listaUnidad();
        DefaultTableModel tabla = (DefaultTableModel)tabla_prod.getModel();
        for(UnidadMedida iter : list){
        ...
        //ButtonColumn b=new ButtonColumn(tabla_prod, new FuncionamientoBotonesCargos(tabla_prod, list), 0);
    ...
    private void initComponents() {
        ...
        bAgregar.setText("+ Agregar unidad");
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        ...
        Sanguchito.sanguchito.removeAll();
        AgregarUnidad opcion = new AgregarUnidad();
