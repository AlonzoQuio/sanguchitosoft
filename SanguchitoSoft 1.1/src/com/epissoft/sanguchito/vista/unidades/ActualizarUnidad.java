...
public class ActualizarUnidad extends javax.swing.JInternalFrame {
    private UnidadMedida unidad;
    public ActualizarUnidad(UnidadMedida u) {
        initComponents();
        ...
        unidad=u;
        tNombre.setText(unidad.getUniMedDes());
    }
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        String mensaje = UnidadMedidaControlador.actualizarUnidadMedida(unidad.getUniMedCod(),tNombre.getText());
