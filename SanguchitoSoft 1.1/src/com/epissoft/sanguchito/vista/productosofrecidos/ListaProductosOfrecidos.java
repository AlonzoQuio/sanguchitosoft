...
public class ListaProductosOfrecidos extends javax.swing.JInternalFrame {
    
    private CategoriaProducto categoria;
    public ListaProductosOfrecidos(CategoriaProducto cat) {
        initComponents();
        ...
        List<Producto> list = MostrarProductoControlador.productosPorTipo(categoria.getCatProdCod());
        
        DefaultTableModel tabla = (DefaultTableModel) tabla_prod.getModel();
        for (Producto pedido : list) {
            Object[] data = {new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ajuste.png")), pedido.getProDes(), pedido.getProPreSol(), pedido.getProPreCar()};
            tabla.addRow(data);
        }
        tabla_prod.setModel(tabla);
        tabla_prod.setRowHeight(50);
        ButtonColumn b = new ButtonColumn(tabla_prod, new FuncionamientoBotonesListaProductos(tabla_prod, list, categoria), 0);
    }
    ...
    private void initComponents() {
        ...
        bInhabilitados = new javax.swing.JButton();
        ...
        lTitulo.setText("  LISTADO DE PRODUCTOS OFRECIDOS");
        ...
        bInhabilitados.setBackground(new java.awt.Color(0, 51, 102));
        bInhabilitados.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        bInhabilitados.setForeground(new java.awt.Color(255, 255, 255));
        bInhabilitados.setText("Productos inhabilitados");
        bInhabilitados.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bInhabilitadosActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(27, 27, 27)
                        .addComponent(bInhabilitados, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bInhabilitados, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(95, 95, 95))
        );
    ...
    private void bCerrarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCerrarSesionActionPerformed
       Sanguchito.sanguchito.removeAll();
        ListaCategoriasProductosOfrecidos productos=new ListaCategoriasProductosOfrecidos();
        Sanguchito.sanguchito.add(productos);
        try{
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        // TODO add your handling code here:
        Sanguchito.sanguchito.removeAll();
        AgregarProductosOfrecidos productosOfrecidos = new AgregarProductosOfrecidos(categoria);
    ...
    private void bInhabilitadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bInhabilitadosActionPerformed
        Sanguchito.sanguchito.removeAll();
        ProdOfrecidosInhabilitados productosOfrecidos = new ProdOfrecidosInhabilitados(categoria);
        Sanguchito.sanguchito.add(productosOfrecidos);
        try {
            productosOfrecidos.setMaximum(true);
        } catch (Exception e) {
        ...
        productosOfrecidos.show();
    }//GEN-LAST:event_bInhabilitadosActionPerformed
    ...
    private javax.swing.JButton bInhabilitados;
