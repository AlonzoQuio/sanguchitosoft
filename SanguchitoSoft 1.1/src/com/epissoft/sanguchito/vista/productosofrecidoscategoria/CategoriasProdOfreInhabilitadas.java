...
public class CategoriasProdOfreInhabilitadas extends javax.swing.JInternalFrame {
    List<CategoriaProducto> inhabilitadas;
    public CategoriasProdOfreInhabilitadas() {
        initComponents();
        ...
        inhabilitadas=CategoriaProductoControlador.listaCategoriaProductoInhabilitadas();
        cargarDatos();
    }
    ...
    private void initComponents() {
        ...
        lTitulo.setText("   Categorías de Productos Ofrecidos  Inhabilitadas");
    ...
    private void bHabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bHabilitarActionPerformed
        if(jTable1.getSelectedRow()>=0){
            CategoriaProductoControlador.habilitarCategoriaProducto(inhabilitadas.get(jTable1.getSelectedRow()).getCatProdCod());
            List<Producto> p = MostrarProductoControlador.productosPorTipo(inhabilitadas.get(jTable1.getSelectedRow()).getCatProdCod());
            for(Producto prod:p){
                HabilitarProductoControlador.habilitarProducto(prod.getProCod());
            }
            inhabilitadas.get(jTable1.getSelectedRow()).setCatProdEst(true);
            cargarDatos();
         }
    ...
    private void cargarDatos(){
        ...
        for(CategoriaProducto dato : inhabilitadas){
            Object[]data ={dato.getCatProdDes()
                    ,(dato.getCatProdEst())?"Habilitado":"Inhabilitado"};
            tabla.addRow(data);            
        }       
