...
public class ListaCategoriasProductosOfrecidos extends javax.swing.JInternalFrame{
    
    public ListaCategoriasProductosOfrecidos() {
        listaCategorias();
        initComponents();
    ...
    private void initComponents() {
        ...
        bHabilitar.setText("Habilitar categorias");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(bHabilitar, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bHabilitar, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bHabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bHabilitarActionPerformed
        ...
        CategoriasProdOfreInhabilitadas opcion=new CategoriasProdOfreInhabilitadas();
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        Sanguchito.sanguchito.removeAll();
        AgregarCategoriaProductoOfrecido agregar=new AgregarCategoriaProductoOfrecido();
    ...
    private void listaCategorias(){
        List<CategoriaProducto> p= CategoriaProductoControlador.listaCategoriaProducto();
        setLayout(null);
        JButton aBu;
        for (int i = 0; i < p.size(); i++) {
            aBu = new JButton(p.get(i).getCatProdDes());
            aBu.setBounds(45 + (i % 5) * 170, 200 + 110 * (int) (i / 5), 160, 100);
            try{
                aBu.setIcon(new javax.swing.ImageIcon("Imagenes/" + p.get(i).getCatProdImg()));    
            }catch(Exception e){
                aBu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/sprodAlmDefault.png")));    
            }
            aBu.addActionListener(new FuncionamientoBotonesListaCategoriasProductos(p.get(i)));
            add(aBu);
        }
    }
}
