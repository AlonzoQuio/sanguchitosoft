 ...
 */
public class InhabilitarCatProdOfre extends javax.swing.JInternalFrame {

    CategoriaProducto categoria;
    public InhabilitarCatProdOfre(CategoriaProducto cat) {
        initComponents();
        categoria=cat;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("  Inhabilitar Categoría");

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));

        jLabel6.setBackground(new java.awt.Color(255, 255, 255));
        jLabel6.setFont(new java.awt.Font("Cambria", 0, 24)); // NOI18N
        jLabel6.setText("¿La categoría será inhabilitada. ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        CategoriaProductoControlador.inhabilitarCategoriaProducto(categoria.getCatProdCod());
        List<Producto> p = MostrarProductoControlador.productosPorTipo(categoria.getCatProdCod());
        for(Producto prod:p){
            InhabilitarProductoControlador.inhabilitarProducto(prod.getProCod());
        }
