...
public class ListaOpcionesExtras extends javax.swing.JInternalFrame {
    private Extras extra;
    private CategoriaExtra categoria;
    public ListaOpcionesExtras(Extras e ,CategoriaExtra cat) {
        initComponents();
        extra=e;
        categoria=cat;
        nomCategoria.setText(extra.getExtDes());
    }
    ...
    private void initComponents() {
        ...
        bModificarCat.setText("Actualizar");
        ...
        bInhabilitarCat.setText("Inhabilitar");
    ...
    private void bModificarCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bModificarCatActionPerformed
        ...
        ActualizarExtra extras=new ActualizarExtra(extra,categoria);
    ...
    private void bInhabilitarCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bInhabilitarCatActionPerformed
        InhabilitarExtra opciones=new InhabilitarExtra(extra);
