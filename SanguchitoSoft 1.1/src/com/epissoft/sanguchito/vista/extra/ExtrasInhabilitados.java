...
public class ExtrasInhabilitados extends javax.swing.JInternalFrame {
    
    private CategoriaExtra categoria;
    private List<Extras> inhabilitados;
    public ExtrasInhabilitados(CategoriaExtra cat) {
        initComponents();
        ...
        categoria=cat;
        inhabilitados=ExtraControlador.listaExtrasInhabilitadosPorCategoria(categoria.getCatExtCod());
        cargarDatos();
    }
    ...
    private void bHabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bHabilitarActionPerformed
        if(jTable1.getSelectedRow()>=0){
            ExtraControlador.habilitarExtra(inhabilitados.get(jTable1.getSelectedRow()).getExtCod());
            inhabilitados.get(jTable1.getSelectedRow()).setExtEst(true);
            cargarDatos();
         }
    ...
    private void cargarDatos(){
        ...
        for(Extras dato : inhabilitados){
            Object[]data ={dato.getExtDes()
                    ,(dato.getExtEst())?"Habilitado":"Inhabilitado"};
            tabla.addRow(data);            
        }       
