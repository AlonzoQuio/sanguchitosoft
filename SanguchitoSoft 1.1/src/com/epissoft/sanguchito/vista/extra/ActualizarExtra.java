...
public class ActualizarExtra extends javax.swing.JInternalFrame {
...
private File[] fotos;
    ...
    private List<CategoriaExtra> categorias;
    public ActualizarExtra(Extras e,CategoriaExtra cat) {
        initComponents();
        ...
        categoria=cat;
        extra=e;
        tNombre.setText(extra.getExtDes());
        tPrecFijo.setText(""+extra.getExtPrecSol());
        tPrecVenta.setText(""+extra.getExtPrecSolCar());
        
        int posCat=0;
        categorias=CategoriaExtraControlador.listaCategoriaExtras();
        for(int i=0;i<categorias.size();i++){
            cCategoria.addItem(categorias.get(i).getCatExtNom());
            if(categorias.get(i).getCatExtCod()==categoria.getCatExtCod()){
                posCat=i;
            }
        }
        cCategoria.setSelectedIndex(posCat);
    }
    ...
    private void initComponents() {
        ...
        lTitulo.setText("  ACTUALIZAR EXTRA");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(cCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        ...
        int catCod = cCategoria.getSelectedIndex();
        if (catCod == -1) {
            catCod = categoria.getCatExtCod();
        } else {
            catCod = categorias.get(catCod).getCatExtCod();
        }
        String resultado = ExtraControlador.actualizarExtra(extra.getExtCod(), tNombre.getText(), tPrecFijo.getText(), tPrecVenta.getText(), catCod, -1);
        if (resultado.equals("CORRECTO")) {
            if(jTImagen.getText().length()>2){
                ...
                File archivo=new File(ManejoSesion.getRuta() + "/Imagenes/ext" + extra.getExtDes()+".png");
                archivo.renameTo(new File(ManejoSesion.getRuta() + "/Imagenes/ext" + tNombre.getText()+".png"));
            }
