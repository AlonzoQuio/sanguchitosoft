...
import com.epissoft.sanguchito.controlador.productoalmacencontrolador.ActualizarProductoAlmacenControlador;
...
public class ActualizarProductoAlmacen extends javax.swing.JInternalFrame {
    
    private List<UnidadMedida> unidades;
    private List<CategoriaProductoAlmacen> categoria;
    private ProductoAlmacen producto;
    private int codCategoria;
    public ActualizarProductoAlmacen(int codCat,ProductoAlmacen prod) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lTitulo.setText("  ACTUALIZAR PRODUCTO DE ALMACÉN");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cUnidad, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(52, 52, 52)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cUnidad, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        int pos=cUnidad.getSelectedIndex();
        int posCat=cCategoria.getSelectedIndex();
        if(posCat>=0){
            if(pos>=0){
                int codUnidad=unidades.get(pos).getUniMedCod();
                int codCategoria=categoria.get(posCat).getCatProdAlmCod();
                String mensaje = ActualizarProductoAlmacenControlador.actualizarProductoAlmacen(producto.getProdAlmCod(),tNombre.getText(), "catProdAlm" + tNombre.getText() + ".png",codCategoria,codUnidad);
                ...
                JOptionPane.showMessageDialog(null,"Debe seleccionar una unidad de medida","Error",JOptionPane.ERROR_MESSAGE);
            }
        }else{
            JOptionPane.showMessageDialog(null,"Debe seleccionar una categoria","Error",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void cargarDatos(){
        tNombre.setText(producto.getProdAlmDes());
        unidades=UnidadMedidaControlador.listaUnidad();
        int posicionUnidad=0;
        for(int i=0;i<unidades.size();i++){
            cUnidad.addItem(unidades.get(i).getUniMedDes());
            if(unidades.get(i).getUniMedCod()==producto.getUniMedCod().getUniMedCod()){
                posicionUnidad=i;
            }
        }
        cUnidad.setSelectedIndex(posicionUnidad);
        
        int posCategoria=0;
        categoria=MostrarCategoriaProductoAlmacenControlador.listaCategoriaProductoAlmacen();
        for(int i=0;i<categoria.size();i++){
            cCategoria.addItem(categoria.get(i).getCatProdAlmDes());
            if(categoria.get(i).getCatProdAlmCod()==codCategoria){
                posCategoria=i;
            }
        }
        cCategoria.setSelectedIndex(posCategoria);
    }
    private void atras(){
        Sanguchito.sanguchito.removeAll();
        ListaProductosAlmacen categoriasAlmacen=new ListaProductosAlmacen(producto.getCatProdAlmCod());
    ...
    private javax.swing.JComboBox cUnidad;
