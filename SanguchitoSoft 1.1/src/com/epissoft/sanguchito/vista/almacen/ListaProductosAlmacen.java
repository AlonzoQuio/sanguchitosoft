...
public class ListaProductosAlmacen extends javax.swing.JInternalFrame{
    private CategoriaProductoAlmacen categoria;   
    public ListaProductosAlmacen(CategoriaProductoAlmacen cat) {
        initComponents();
        categoria = cat;
        ...
        ButtonColumn b = new ButtonColumn(tabla_prod, new FuncionamientoBotonesListaProductosAlmacen(tabla_prod, list), 0);
    ...
    private void initComponents() {
        ...
        lTitulo.setText("  LISTADO DE PRODUCTOS DEL ALMACEN");
        ...
        tabla_prod.getColumnModel().getColumn(0).setPreferredWidth(40);
        tabla_prod.getColumnModel().getColumn(1).setResizable(false);
        tabla_prod.getColumnModel().getColumn(2).setResizable(false);
        tabla_prod.getColumnModel().getColumn(2).setPreferredWidth(40);
        tabla_prod.getColumnModel().getColumn(3).setResizable(false);
