...
import com.epissoft.sanguchito.vista.cargos.*;
...
public class ListaEmpleadosTurno extends javax.swing.JInternalFrame {
    private Turno turno;
    public ListaEmpleadosTurno(Turno t) {
        ...
        turno=t;
        List<Empleado> list = new EmpleadoControlador().buscarPorTurno(turno.getTurCod());
        DefaultTableModel tabla = (DefaultTableModel)tabla_empleados.getModel();
        for(Empleado iter : list){
            Object[]data ={
                new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ajuste.png")),
                iter.getEmpDni(),
                iter.getEmpNom()+" "+iter.getEmpApePat()+" "+iter.getEmpApeMat(),
                iter.getEmpDir(),
                iter.getCarCod().getCarDes(),
                iter.getEmpTel1()
            };
            tabla.addRow(data);            
        }       
        tabla_empleados.setModel(tabla);
        tabla_empleados.setRowHeight(50);
        ButtonColumn b=new ButtonColumn(tabla_empleados, new FuncionamientoBotonesEmpleadosTurno(tabla_empleados, list), 0);
    }
    ...
    private void initComponents() {
        ...
        lTitulo.setText("  LISTADO DE EMPLEADOS PERTENECIENTES A ESTE TURNO");
        ...
        bAgregar.setText("+ Agregar Cargo");
        ...
        tabla_empleados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ajustes", "DNI", "Nombre", "Dirección", "Cargo", "Telefono"
            }
        ) {
        ...
        tabla_empleados.getColumnModel().getColumn(1).setPreferredWidth(90);
        tabla_empleados.getColumnModel().getColumn(2).setPreferredWidth(250);
        tabla_empleados.getColumnModel().getColumn(3).setPreferredWidth(270);
        tabla_empleados.getColumnModel().getColumn(4).setPreferredWidth(100);
        tabla_empleados.getColumnModel().getColumn(5).setPreferredWidth(100);
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
       // TODO add your handling code here:
        Sanguchito.sanguchito.removeAll();
        AgregarCargo actualizar = new AgregarCargo();
