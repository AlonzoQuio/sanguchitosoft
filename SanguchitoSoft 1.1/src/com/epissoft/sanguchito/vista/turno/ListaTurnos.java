...
public class ListaTurnos extends javax.swing.JInternalFrame {
    ...
    public ListaTurnos() {
        ...
        List<Turno> list = TurnoControlador.ListaTurnos();
        ...
        for(Turno iter : list){
            Object[]data ={new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ajuste.png")),
                iter.getTurDes(),
                iter.getTurHorIni().getHours()+":"+iter.getTurHorIni().getMinutes(),
                iter.getTurHorFin().getHours()+":"+iter.getTurHorFin().getMinutes()};
            tabla.addRow(data);            
        }       
        tabla_prod.setModel(tabla);
        tabla_prod.setRowHeight(50);
        ButtonColumn b=new ButtonColumn(tabla_prod, new FuncionamientoBotonesTurnos(tabla_prod, list), 0);
    ...
    private void initComponents() {
        ...
        tabla_prod.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ajustes", "Nombre", "Hora de inicio", "Hora de salida"
            }
        ) {
        ...
        bAgregar.setText("+ Agregar Turno");
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        ...
        Sanguchito.sanguchito.removeAll();
        AgregarTurno opcion = new AgregarTurno();
