...
public class ListaCategoriasExtras extends javax.swing.JInternalFrame{
    ...
    private void initComponents() {
        ...
        bInhabilitadas = new javax.swing.JButton();
        ...
        bAgregar.setText("+ Agregar categoria");
        ...
        bInhabilitadas.setBackground(new java.awt.Color(0, 51, 102));
        bInhabilitadas.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        bInhabilitadas.setForeground(new java.awt.Color(255, 255, 255));
        bInhabilitadas.setText("Categorias inhabilitadas");
        bInhabilitadas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bInhabilitadasActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(bInhabilitadas, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bInhabilitadas, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(87, 87, 87))
        );
    ...
    private void bAtras1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAtras1ActionPerformed
        ...
        Sanguchito.sanguchito.add(administrador);
        try{
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        Sanguchito.sanguchito.removeAll();
        AgregarCategoriaExtras agregar=new AgregarCategoriaExtras();
    ...
    private void bInhabilitadasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bInhabilitadasActionPerformed
        Sanguchito.sanguchito.removeAll();
        CategoriaExtrasInhabilitados agregar=new CategoriaExtrasInhabilitados();
        Sanguchito.sanguchito.add(agregar);
        try{
            agregar.setMaximum(true);
        }catch(Exception e){
        ...
        agregar.show();
    }//GEN-LAST:event_bInhabilitadasActionPerformed
    ...
    private javax.swing.JButton bInhabilitadas;
    ...
    private void listaCategorias(){
        List<CategoriaExtra> p= CategoriaExtraControlador.listaCategoriaExtras();
        JButton aBu;
        for (int i = 0; i < p.size(); i++) {
            aBu = new JButton(p.get(i).getCatExtNom());
            aBu.setBounds(45 + (i % 5) * 170, 200 + 110 * (int) (i / 5), 160, 100);
            try{
                aBu.setIcon(new javax.swing.ImageIcon("Imagenes/" + p.get(i).getCatExtImg()));    
            }catch(Exception e){
                aBu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/catExtDefault.png")));    
            }
            aBu.addActionListener(new FuncionamientoBotonesListaCategoriasExtras(p.get(i)));
            add(aBu);
        }
    }
}
