 ...
 */
public class InhabilitarCategoriaExtra extends javax.swing.JInternalFrame {

    CategoriaExtra extra;
    public InhabilitarCategoriaExtra(CategoriaExtra e) {
        initComponents();
        extra=e;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("  Inhabilitar Extra");

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));

        jLabel6.setBackground(new java.awt.Color(255, 255, 255));
        jLabel6.setFont(new java.awt.Font("Cambria", 0, 24)); // NOI18N
        jLabel6.setText("¿La categoria será inhabilitada. ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        CategoriaExtraControlador.inhabilitarCategoriaExtra(extra.getCatExtCod());
        dispose();
