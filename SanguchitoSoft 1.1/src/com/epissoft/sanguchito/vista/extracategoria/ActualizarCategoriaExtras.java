...
public class ActualizarCategoriaExtras extends javax.swing.JInternalFrame {
    
private File[] fotos;
    CategoriaExtra categoria;
    public ActualizarCategoriaExtras(CategoriaExtra cat) {
        initComponents();
        ...
        categoria=cat;
        tNombre.setText(categoria.getCatExtNom());
        tDes.setText(categoria.getCatExtDes());
    }
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        ...
        String resultado = CategoriaExtraControlador.actualizarCategoriaExtra(categoria.getCatExtCod(),tNombre.getText(), tDes.getText(), "catProdExt" + tNombre.getText() + ".png");
        if (resultado.equals("CORRECTO")) {
            if(jTImagen.getText().length()>2){
                ...
                File archivo=new File(ManejoSesion.getRuta() + "/Imagenes/" + categoria.getCatExtImg());
                archivo.renameTo(new File(ManejoSesion.getRuta() + "/Imagenes/catProdExt" + tNombre.getText()+".png"));
            }
            atras();
        } else {
