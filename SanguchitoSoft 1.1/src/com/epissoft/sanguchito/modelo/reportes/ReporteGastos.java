...
public class ReporteGastos {
    ...
    public void reportdiagasto(String concepto_,String autor_,String anio_, String mes_, String dia_,String tipo){
        ...
        String ruta="Reportexdiagastos.jasper";
        if( "1".equals(tipo))
        {
        ruta="Reportexdiagastos.jasper";
        }
         if( "2".equals(tipo))
        {
        ruta="Reportexdiagastos(barrashorizontales).jasper";
        }
          if( "3".equals(tipo))
        {
        ruta="Reportexdiagastostorta.jasper";
        }
    ...
    ////////////////////////7
      public void reportsemana(String concepto_,String autor_,String anio_, String mes_, String dia_min,String dia_max,String tipo){
        ...
        try {
          Class.forName("org.postgresql.Driver");
         Connection conexion = DriverManager.getConnection("jdbc:postgresql://hard-plum.db.elephantsql.com:5432/hqwzxyfi", "hqwzxyfi", "MGnLXRQtfoVG_weLGP1iUAgCJO2j4Cp8");
        String ruta="Reportexsemanagastos.jasper";
        if( "1".equals(tipo))
        {
        ruta="Reportexsemanagastos.jasper";
        }
         if( "2".equals(tipo))
        {
        ruta="Reportexsemanagastos(barrashorizontales).jasper";
        }
          if( "3".equals(tipo))
        {
        ruta="Reportexsemanagastostorta.jasper";
        }
      ...
      //////////////////////////
        ...
        try {
         ...
         String ruta="Reportexmesgastos.jasper";
        if( "1".equals(tipo))
        {
        ruta="Reportexmesgastos.jasper";
        }
         if( "2".equals(tipo))
        {
        ruta="Reportexmesgastos(barrashorizontales).jasper";
        }
          if( "3".equals(tipo))
        {
        ruta="Reportexmesgastostorta.jasper";
        }
  ...
  public void reportanio(String concepto_,String autor_,String anio_,String tipo){
        ...
        try {
          Class.forName("org.postgresql.Driver");
         Connection conexion = DriverManager.getConnection("jdbc:postgresql://hard-plum.db.elephantsql.com:5432/hqwzxyfi", "hqwzxyfi", "MGnLXRQtfoVG_weLGP1iUAgCJO2j4Cp8");
        String ruta="Reportexaniogastos.jasper";
        if( "1".equals(tipo))
        {
        ruta="Reportexaniogastos.jasper";
        }
         if( "2".equals(tipo))
        {
        ruta="Reportexaniogastos(barrashorizontales).jasper";
        }
          if( "3".equals(tipo))
        {
        ruta="Reportexaniogastostorta.jasper";
        }
      ...
      public void reportperiodo(String concepto_,String autor_,String anio_min,String anio_max, String mes_min,String mes_max, String dia_min,String dia_max,String tipo){
        ...
        try {
          Class.forName("org.postgresql.Driver");
         Connection conexion = DriverManager.getConnection("jdbc:postgresql://hard-plum.db.elephantsql.com:5432/hqwzxyfi", "hqwzxyfi", "MGnLXRQtfoVG_weLGP1iUAgCJO2j4Cp8");
        String ruta="Reportexperiodogastos.jasper";
        if( "1".equals(tipo))
        {
        ruta="Reportexperiodogastos.jasper";
        }
         if( "2".equals(tipo))
        {
        ruta="Reportexperiodogastos(barrashorizontales).jasper";
        }
          if( "3".equals(tipo))
        {
        ruta="Reportexperiodogastostorta.jasper";
        }
